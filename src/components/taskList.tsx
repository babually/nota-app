...
import type { SortOption, Task } from '@/types/tssk'
      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center justify-between mb-4">
          ...
          <Modal isOpen={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>           
            ...
            <Modal.Content className="sm:max-w-[500px]" size='3xl'>
              <Modal.Header>
        ...
        <div className="flex space-x-3">
          ...
          <Select defaultSelectedKey={sortBy} onSelectionChange={(value) => onSortChange(value as SortOption)}>
            <Select.Trigger className="w-40"/>
            <Select.List>
              {sortOptions.map((option) => (
                <Select.Option key={option.value} textValue={option.value}>
                  {option.label}
                </Select.Option>
              ))}
            </Select.List>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <Badge intent="outline" className={getPriorityColor(task.priority)}>
